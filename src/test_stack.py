...
class getterTesting(StackOverflow.StackOverflowAPI):
    ...
    def __init__(self, exception):
        ...
        self.stack_data = {'tags': ['python'], 
        'comments': [
            {'owner': {'reputation': 330022, 'user_id': 908494, 'user_type': 'registered', 'accept_rate': 25, 
            'profile_image': 'https://www.gravatar.com/avatar/7e41acaa8f6a0e0f5a7c645e93add55a?s=256&d=identicon&r=PG', 
            'display_name': 'abarnert', 'link': 'https://stackoverflow.com/users/908494/abarnert'}, 
            'edited': False, 'score': 2, 'creation_date': 1429839652, 'post_id': 29836964, 'comment_id': 47801181, 
            ...
            {'owner': {'reputation': 3538, 'user_id': 925592, 'user_type': 'registered', 'accept_rate': 50, 
            'profile_image': 'https://i.stack.imgur.com/e3X1a.jpg?s=256&g=1', 'display_name': 'RufusVS', 'link': 'https://stackoverflow.com/users/925592/rufusvs'}, 
            'edited': False, 'score': 0, 'creation_date': 1627436557, 'post_id': 29836964, 'comment_id': 121154019, 
            'body': 'There is an error in your logic if you come across a situation where you are dividing by zero.'}], 
            'answers': [{'tags': ['python'], 'owner': {'reputation': 166347, 'user_id': 416467, 'user_type': 'registered', 
            'accept_rate': 100, 'profile_image': 'https://www.gravatar.com/avatar/32cad7487ccecc3740a62e797fc326dc?s=256&d=identicon&r=PG', 
            'display_name': 'kindall', 'link': 'https://stackoverflow.com/users/416467/kindall'}, 'is_accepted': True, 'score': 67, 
            'last_activity_date': 1637275638, 'last_edit_date': 1637275638, 'creation_date': 1429837608, 'answer_id': 29836987, 
            'question_id': 29836964, 'link': 'https://stackoverflow.com/questions/29836964/error-python-zerodivisionerror-division-by-zero/29836987#29836987', 
            'title': 'Error python : [ZeroDivisionError: division by zero]', 'body': "<p>Catch the error and handle it:</p>\n<pre><code>try:\n    z = x / y\nexcept ZeroDivisionError:\n    z = 0\n</code></pre>\n<p>Or check before you do the division:</p>\n<pre><code>if y == 0:\n    z = 0\nelse:\n    z = x / y\n</code></pre>\n<p>The latter can be reduced to:</p>\n<pre><code>z = 0 if y == 0 else (x / y) \n</code></pre>\n<p>Or if you're sure <code>y</code> is a number, which implies it`s truthy if nonzero:</p>\n<pre><code>z = (x / y) if y else 0\nz = y and (x / y)   # alternate version\n</code></pre>\n"}, 
            {'tags': ['python'], 'owner': {'reputation': 1157, 'user_id': 8234870, 'user_type': 'registered', 
            'profile_image': 'https://www.gravatar.com/avatar/aa94b5af8b4585d838685b291e550607?s=256&d=identicon&r=PG&f=1', 
            'display_name': 'Dev Parzival', 'link': 'https://stackoverflow.com/users/8234870/dev-parzival'}, 'is_accepted': False, 'score': 0, 
            'last_activity_date': 1636539630, 'creation_date': 1636539630, 'answer_id': 69911495, 'question_id': 29836964, 
            'link': 'https://stackoverflow.com/questions/29836964/error-python-zerodivisionerror-division-by-zero/69911495#69911495', 
            'title': 'Error python : [ZeroDivisionError: division by zero]', 'body': "<pre><code># we are dividing until correct data is given\nexecuted = False\nwhile not executed:\n    try:\n        a = float(input('first number --&gt; '))\n        b = float(input('second number --&gt; '))\n        z = a / b\n        print(z)\n        executed = True\n    except ArithmeticError as arithmeticError:\n        print(arithmeticError)\n    except ValueError as valueError:\n        print(valueError)\n    except Exception as exception:\n        print(exception)\n</code></pre>\n"}], 
            'owner': {'reputation': 9829, 'user_id': 4744765, 'user_type': 'registered', 'accept_rate': 84, 
            'profile_image': 'https://www.gravatar.com/avatar/197b8e8a4085b5cb60ecf4b58b566aa3?s=256&d=identicon&r=PG&f=1', 
            'display_name': 'markov zain', 'link': 'https://stackoverflow.com/users/4744765/markov-zain'}, 'delete_vote_count': 0, 
            'reopen_vote_count': 0, 'close_vote_count': 0, 'is_answered': True, 'view_count': 113396, 'favorite_count': 5, 
            'accepted_answer_id': 29836987, 'answer_count': 2, 'score': 23, 'last_activity_date': 1637275638, 'creation_date': 1429837466, 
            'last_edit_date': 1618712260, 'question_id': 29836964, 'link': 'https://stackoverflow.com/questions/29836964/error-python-zerodivisionerror-division-by-zero', 
