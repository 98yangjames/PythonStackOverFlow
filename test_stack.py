    ...
    def __init__(self):
        ...
        self.stack_data = {'tags': ['python'], 'comments': [{'owner': {'reputation': 330022, 'user_id': 908494,
                                                                       ...
                                                                       'profile_image': 'https://www.gravatar.com'
                                                                                        '/avatar/7e41acaa8f6a0e0f5a7c'
                                                                                        '645e93add55a?s=256&d'
                                                                                        '=identicon&r=PG',
                                                                       'display_name': 'abarnert',
                                                                       'link': 'https://stackoverflow.com/'
                                                                               'users/908494/abarnert'},
                                                             'edited': False, 'score': 2, 'creation_date': 1429839652,
                                                             'post_id': 29836964, 'comment_id': 47801181,
                                                             'body': 'What value do you want for <code>1&#47;0</code>?'
                                                                     ' For <code>0&#47;0</code>, any value at all makes'
                                                                     ' some sense (because <code>x&#47;y==z</code> still'
                                                                     ' implies <code>z**y==x</code>), but for anything'
                                                                     ' else divided by 0, no value makes sense '
                                                                     '(unless you have an infinite integer, '
                                                                     'and define <code>infinity*0 == 0</code>).'},
                           ...
                           'answers': [{'tags': ['python'],
                                       ...
                                       {'tags': ['python'],
                                        ...
                                        'link': 'https://stackoverflow.com/questions/29836964/error-python-'
                                                'zerodivisionerror-division-by-zero/69911495#69911495',
                                        'title': 'Error python : [ZeroDivisionError: division by zero]',
                           ...
                           'owner': {'reputation': 9829, 'user_id': 4744765, 'user_type': 'registered',
                                     'accept_rate': 84,
                                     'profile_image': 'https://www.gravatar.com/avatar/'
                                                      '197b8e8a4085b5cb60ecf4b58b566aa3?s=256&d=identicon&r=PG&f=1',
                           ...
                           'body': '<p>I faced an error when I run my program using python:\n'
                                   ...
                                   '5-30b5d8268cca&gt; in &lt;module&gt;()\n      1 x = 0\n      2 y = 0\n----&gt;'
                                   ' 3 z = x/y\n\nZeroDivisionError: division by zero\n</code></pre>\n<p>Thus, '
                                   'I want to ask, how to avoid that error in python. My desired output is '
                                   '<code>z = 0</code></p>\n'}
